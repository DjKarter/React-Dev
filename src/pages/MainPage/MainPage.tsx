    ...
    return (
        <>
            ...
            <ul className={'main-ul'}>
                <li><button onClick={() => {setUseStatePage(!useStatePage); setMainPage(!mainPage)}}>
                    1) useState.
                </button></li>

                <li><button onClick={() => {setTicTacToePage(!ticTacToePage); setMainPage(!mainPage)}}>
                    2) Tic-Tac-Toe.
                </button></li>

                <li><button onClick={() => {setProductTablePage(!productTablePage); setMainPage(!mainPage)}}>
                    3) Product Table.
                </button></li>
